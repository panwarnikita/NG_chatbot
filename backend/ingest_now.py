...
#     data_path = os.path.join(BASE_DIR, "data", "about_ng.txt")

#     if not os.path.exists(data_path):
#         print("Error: can not find data folder")
#         return
...
#     )
#     if using_cloud:
#         print("✅ Success! Qdrant Cloud collection update ho gaya.")
#     else:
#         print("✅ Success! 'vectorstore_qdrant' folder ban gaya hai.")
